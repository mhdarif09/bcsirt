...
if ( ! function_exists( 'exs_customize_register' ) ) :
	function exs_customize_register( $wp_customize ) {
		...
		$wp_customize->get_setting( 'post_thumbnails_disable_hover_effect' )->transport = 'postMessage';
		...
		//headings
		foreach( array( 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'post_title', 'post_title_single' ) as $h ) {
			$wp_customize->get_setting( 'typo_size_' . $h )->transport = 'postMessage';
			$wp_customize->get_setting( 'typo_line_height_' . $h )->transport = 'postMessage';
			$wp_customize->get_setting( 'typo_letter_spacing_' . $h )->transport = 'postMessage';
			$wp_customize->get_setting( 'typo_weight_' . $h )->transport = 'postMessage';
			$wp_customize->get_setting( 'typo_mt_' . $h )->transport = 'postMessage';
			$wp_customize->get_setting( 'typo_mb_' . $h )->transport = 'postMessage';
		}
	...
	function exs_intro_teasers_options() {
		...
		for ( $i = 1; $i < 5; $i ++ ) {
			...
			*/
			...
			$array[ 'intro_teaser_button_type_' . $i ] = array(
				'type'    => 'select',
				'section' => 'static_front_page',
				'label'   => esc_html__( 'Featured block button type #', 'exs' ) . $i,
				'default' => esc_html( exs_option( 'intro_teaser_button_type_' . $i, '' ) ),
				'choices'     => array(
					''    => esc_html__( 'Default', 'exs' ),
					'wp-block-button__link' => esc_html__( 'Button', 'exs' ),
					'is-style-outline wp-block-button__link ' => esc_html__( 'Outline Button', 'exs' ),
				),
			);
		}
...
if ( ! function_exists( 'exs_headings_typography_customizer_options' ) ) :
	function exs_headings_typography_customizer_options() {
		...
		$titles = array(
			'post_title' => esc_html__( 'Archive post titles', 'exs' ),
			'post_title_single' => esc_html__( 'Single post titles', 'exs' ),
		);

		foreach ( $titles as $i => $title_name ) {
			$array[ 'typo_heading_' . $i ]       = array(
				'type'        => 'block-heading',
				'section'     => 'section_typography',
				'label'       => esc_html__( 'Settings for ', 'exs' ) . $title_name,
				'description' => esc_html__( 'Set your settings for headings. Leave blank for theme defaults.', 'exs' ),
			);
			$array[ 'typo_size_' . $i ]       = array(
				'type'        => 'slider',
				'label'       => esc_html__( 'Font Size for ', 'exs' ) . $title_name,
				'description' => esc_html__( 'Value in ems', 'exs' ),
				'section'     => 'section_typography',
				'default'     => esc_html( exs_option( 'typo_size_' . $i, '' ) ),
				'atts'        => array(
					'min'  => '1',
					'max'  => '4',
					'step' => '0.05',
			...
			$array[ 'typo_line_height_' . $i ]       = array(
				'type'        => 'slider',
				'label'       => esc_html__( 'Line Height for ', 'exs' ) . $title_name,
				'description' => esc_html__( 'Value in ems', 'exs' ),
				'section'     => 'section_typography',
				'default'     => esc_html( exs_option( 'typo_line_height_' . $i, '' ) ),
				'atts'        => array(
					'min'  => '0.4',
					'max'  => '3',
					'step' => '0.05',
			...
			$array[ 'typo_letter_spacing_' . $i ]       = array(
				'type'        => 'slider',
				'label'       => esc_html__( 'Letter Spacing for ', 'exs' ) . $title_name,
				'description' => esc_html__( 'Value in ems', 'exs' ),
				'section'     => 'section_typography',
				'default'     => esc_html( exs_option( 'typo_letter_spacing_' . $i, '' ) ),
				'atts'        => array(
					'min'         => '-0.2',
					'max'         => '0.5',
					'step'        => '0.005',
			...
			$array[ 'typo_weight_' . $i ] = array(
				'type'        => 'select',
				'label'       => esc_html__( 'Font Weight for ', 'exs' ) . $title_name,
				'default'     => esc_html( exs_option( 'typo_weight_' . $i, '' ) ),
				'section'     => 'section_typography',
				'choices'     => array(
					''    => esc_html__( 'Default', 'exs' ),
					'100' => esc_html__( '100', 'exs' ),
			...
			$array[ 'typo_mt_' . $i ]       = array(
				'type'        => 'slider',
				'label'       => esc_html__( 'Top Margin in ems for ', 'exs' ) . $title_name,
				'section'     => 'section_typography',
				'default'     => esc_html( exs_option( 'typo_mt_' . $i, '' ) ),
				'atts'        => array(
					'min'         => '0',
					'max'         => '4',
					'step'        => '0.05',
			...
			$array[ 'typo_mb_' . $i ]       = array(
				'type'        => 'slider',
				'label'       => esc_html__( 'Bottom Margin in ems for ', 'exs' ) . $title_name,
				'section'     => 'section_typography',
				'default'     => esc_html( exs_option( 'typo_mb_' . $i, '' ) ),
				'atts'        => array(
					'min'         => '0',
					'max'         => '4',
					'step'        => '0.05',
