...
if ( ! function_exists( 'exs_widgets_init' ) ) :
	...
	function exs_widgets_init() {
		...
		//since 2.4.0
		//new top and bottom archive and post sidebars
		if ( exs_option( 'blog_top_bottom_widget_area_enabled' ) ) {
			register_sidebar(
				array(
					'name'          => esc_html__( 'Archive Top Sidebar', 'exs' ),
					'id'            => 'sidebar-archive-top',
					'description'   => esc_html__( 'Sidebar will appear at the top of your post archives', 'exs' ),
					'before_widget' => '<div id="%1$s" class="widget %2$s">',
					'after_widget'  => '</div>',
					'before_title'  => '<h3 class="widget-title"><span>',
					'after_title'   => '</span></h3>',
			...
			register_sidebar(
				array(
					'name'          => esc_html__( 'Archive Bottom Sidebar', 'exs' ),
					'id'            => 'sidebar-archive-bottom',
					'description'   => esc_html__( 'Sidebar will appear at the bottom of your post archives', 'exs' ),
					'before_widget' => '<div id="%1$s" class="widget %2$s">',
					'after_widget'  => '</div>',
					'before_title'  => '<h3 class="widget-title"><span>',
					'after_title'   => '</span></h3>',
		...
		if ( exs_option( 'blog_single_top_bottom_widget_area_enabled' ) ) {
			register_sidebar(
				array(
					'name'          => esc_html__( 'Single Post Top Sidebar', 'exs' ),
					'id'            => 'sidebar-post-top',
					'description'   => esc_html__( 'Sidebar will appear at the top of your posts', 'exs' ),
					'before_widget' => '<div id="%1$s" class="widget %2$s">',
					'after_widget'  => '</div>',
					'before_title'  => '<h3 class="widget-title"><span>',
					'after_title'   => '</span></h3>',
			...
			register_sidebar(
				array(
					'name'          => esc_html__( 'Single Post Bottom Sidebar', 'exs' ),
					'id'            => 'sidebar-post-bottom',
					'description'   => esc_html__( 'Sidebar will appear at the bottom of your posts', 'exs' ),
					'before_widget' => '<div id="%1$s" class="widget %2$s">',
					'after_widget'  => '</div>',
					'before_title'  => '<h3 class="widget-title"><span>',
					'after_title'   => '</span></h3>',
...
if( ! function_exists( 'exs_process_ajax_form' ) ) :
	function exs_process_ajax_form() {
		...
		if ( empty( $mailchimp ) ) :
			...
			$custom_to = exs_option( 'contact_email' );
			$to_email = ! empty( $custom_to ) ? $custom_to : get_option( 'admin_email' );

			$result = wp_mail( $to_email, $subject_text, $message_meta . "\r\n" . $message_text, $headers );
