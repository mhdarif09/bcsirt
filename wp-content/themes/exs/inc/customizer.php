			...
			array(
				...
				*/
				...
				'assets_min'                            => array(
					'type'            => 'checkbox',
					'section'         => 'section_layout',
					'label'           => esc_html__( 'Use minified version of theme CSS files', 'exs' ),
				...
				'layout_post_thumbnails_options_heading'        => array(
					'type'        => 'block-heading',
					'section'     => 'section_layout',
					'label'       => esc_html__( 'Post Thumbnails options', 'exs' ),
					'description' => esc_html__( 'Customize your post featured images behavior.', 'exs' ),
				),
				...
				'post_thumbnails_disable_hover_effect'             => array(
					'type'        => 'checkbox',
					'section'     => 'section_layout',
					'label'       => esc_html__( 'Disable zoom effect on article hover', 'exs' ),
					'description' => esc_html__( 'If you do not need animate your post featured images on mouse hover, check this option', 'exs' ),
					'default'     => esc_html( exs_option( 'post_thumbnails_disable_hover_effect', '' ) ),
					'priority'    => 200,
				),
				'layout_block_editor_assets_heading'        => array(
					'type'        => 'block-heading',
					'section'     => 'section_layout',
					'label'       => esc_html__( 'Block Editor Assets', 'exs' ),
					'description' => esc_html__( 'Change new default WordPress editor assets behavior.', 'exs' ),
				),
				...
				'meta_x'                          => array(
					'type'    => 'url',
					'section' => 'section_meta',
					'label'   => esc_html__( 'X - ex Twitter URL', 'exs' ),
					'default' => esc_html( exs_option( 'meta_x', '' ) ),
				),
				'meta_youtube'                          => array(
					'type'    => 'url',
					'section' => 'section_meta',
				...
				'meta_telegram'                           => array(
					'type'    => 'url',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Telegram URL', 'exs' ),
					'default' => esc_html( exs_option( 'meta_telegram', '' ) ),
				),
				'meta_mastodon'                           => array(
					'type'    => 'url',
					'section' => 'section_meta',
					'label'   => esc_html__( 'Mastodon URL', 'exs' ),
					'default' => esc_html( exs_option( 'meta_mastodon', '' ) ),
				),
				'meta_social_blank'                      => array(
					'type'        => 'checkbox',
					'section'     => 'section_meta',
					'label'       => esc_html__( 'Open social links in a new tab', 'exs' ),
					'description' => esc_html__( 'Will add target blank attribute to your social links', 'exs' ),
					'default'     => esc_html( exs_option( 'meta_social_blank', '' ) ),
				),
				/////////////
				//side menu//
				/////////////
				...
				'menu_desktop'                    => array(
					...
					'choices' => array(
						...
						'5' => esc_html__( 'Scale and blur on hover', 'exs' ),
						'6' => esc_html__( 'Dot accent color delimiters', 'exs' ),
						'7' => esc_html__( 'Line accent color delimiters', 'exs' ),
						'8' => esc_html__( 'Dot border color delimiters', 'exs' ),
						'9' => esc_html__( 'Line border color delimiters', 'exs' ),
						'10' => esc_html__( 'Hover only decorations', 'exs' ),
					),
				),
				...
				//login/logout links now has more options
				'header_login_links_heading'        => array(
					'type'        => 'block-heading',
					'section'     => 'section_header',
					'label'       => esc_html__( 'Header Login links options', 'exs' ),
				),
				...
				'header_login_custom_url'                     => array(
					'type'    => 'url',
					'section' => 'section_header',
					'label'   => esc_html__( 'Header Login custom URL', 'exs' ),
					'default' => esc_html( exs_option( 'header_login_custom_url', '' ) ),
				),
				'header_login_custom_text'                     => array(
					'type'    => 'text',
					'section' => 'section_header',
					'label'   => esc_html__( 'Header Login custom Text', 'exs' ),
					'default' => esc_html( exs_option( 'header_login_custom_text', '' ) ),
				),
				'header_logout_custom_url'                     => array(
					'type'    => 'url',
					'section' => 'section_header',
					'label'   => esc_html__( 'Header Logout custom URL', 'exs' ),
					'default' => esc_html( exs_option( 'header_logout_custom_url', '' ) ),
				),
				'header_logout_custom_text'                     => array(
					'type'    => 'text',
					'section' => 'section_header',
					'label'   => esc_html__( 'Header Logout custom Text', 'exs' ),
					'default' => esc_html( exs_option( 'header_logout_custom_text', '' ) ),
				),
				'header_register_custom_url'                     => array(
					'type'    => 'url',
					'section' => 'section_header',
					'label'   => esc_html__( 'Header Register custom URL', 'exs' ),
					'default' => esc_html( exs_option( 'header_register_custom_url', '' ) ),
				),
				'header_register_custom_text'                     => array(
					'type'    => 'text',
					'section' => 'section_header',
					'label'   => esc_html__( 'Header Register custom Text', 'exs' ),
					'default' => esc_html( exs_option( 'header_register_custom_text', '' ) ),
				),
				'header_login_links_new_tab'                    => array(
					'type'        => 'checkbox',
					'section'     => 'section_header',
					'label'       => esc_html__( 'Open Login/Logout links in a new tab', 'exs' ),
					'default'     => esc_html( exs_option( 'header_login_links_new_tab', false ) ),
				),
				...
				'topline_login_links'                    => array(
					...
					'description' => esc_html__( 'Show login link if user is not logged in. Show register link if registration enabled. Show logout link if user is logged in. Links settings will be inherited from the header login links settings', 'exs' ),
				),
				...
				'title'                                 => array(
					...
					'choices' => array(
						...
						'6' => esc_html__( 'Title with a side post featured image', 'exs' ),
						'7' => esc_html__( 'Title with a top post featured image', 'exs' ),
						'8' => esc_html__( 'Title with a bottom post featured image', 'exs' ),
					),
				),
				'title_fluid'                         => array(
					'type'    => 'checkbox',
				...
				'title_blog_single_show_custom_excerpt'           => array(
					'type'    => 'checkbox',
					'section' => 'section_title',
					'label'   => esc_html__( 'Show Custom Excerpt if it is set', 'exs' ),
					'description' => esc_html__( 'You can display your custom post if it is set for your single post pages', 'exs' ),
					'default' => esc_html( exs_option( 'title_blog_single_show_custom_excerpt', false ) ),
				),
				...
				'blog_top_bottom_widget_area_enabled'          => array(
					'type'        => 'checkbox',
					'section'     => 'section_blog',
					'label'       => esc_html__( 'Enable top and bottom archive widget areas', 'exs' ),
					'default'     => esc_html( exs_option( 'blog_top_bottom_widget_area_enabled', false ) ),
					'description' => esc_html__( 'Customizer page refresh required. If checked - additional top and bottom widget areas will be added', 'exs' ),
				),
				...
				'blog_single_top_bottom_widget_area_enabled'          => array(
					'type'        => 'checkbox',
					'section'     => 'section_blog_post',
					'label'       => esc_html__( 'Enable top and bottom post widget areas', 'exs' ),
					'default'     => esc_html( exs_option( 'blog_single_top_bottom_widget_area_enabled', false ) ),
					'description' => esc_html__( 'Customizer page refresh required. If checked - additional top and bottom widget areas will be added.', 'exs' ),
				),
				...
				'blog_single_meta_sidebar'                        => array(
					'type'    => 'checkbox',
					'section' => 'section_blog_post',
					'label'   => esc_html__( 'Show meta at the top of main sidebar', 'exs' ),
					'description' => esc_html__( 'Only for large screens. If selected - post meta will be moved from a regular template position to the top of main sidebar. Sidebar position should be set to left or right.', 'exs' ),
					'default' => esc_html( exs_option( 'blog_single_meta_sidebar', '' ) ),
				),
				...
				'blog_single_read_progress_height' => array(
					'type'        => 'slider',
					'label'       => esc_html__( 'Progress bar height', 'exs' ),
				...
				'blog_single_read_progress_bar_posttypes'                       => array(
					'type'        => 'text',
					'section'     => 'section_blog_post',
					'label'       => esc_html__( 'Reading time Additional Post Types', 'exs' ),
					'description' => esc_html__( 'Coma separated additional post type slugs (eg. page ,portfolio).', 'exs' ),
					'default'     => esc_html( exs_option( 'blog_single_read_progress_bar_posttypes', '' ) ),
				),
				...
				'search_layout'                  => array(
					...
					'choices' => array(
						...
						'meta-bottom'                     => esc_html__( 'Bottom post meta', 'exs' ),
						'meta-image-bottom'               => esc_html__( 'Bottom image and post meta', 'exs' ),
				...
				'contact_email'                  => array(
					'type'    => 'email',
					'label'   => esc_html__( 'Custom recipient email address', 'exs' ),
					'default' => esc_html( exs_option( 'contact_email', '' ) ),
					'description' => esc_html__( 'Contact form emails are sent to admin email by default. You can set your custom email address here', 'exs' ),
					'section'     => 'section_contact_messages',
				),
				//////////////////////
				//mailchimp messages//
...
add_action( 'init', 'exs_init_customizer_class', 9999 );
if ( ! function_exists( 'exs_init_customizer_class' ) ) :
	function exs_init_customizer_class() {
		//since 2.3.0 - extra sidebars
		require_once EXS_THEME_PATH . '/inc/customizer/customizer-cpt.php';
