...
if ( is_customize_preview() ) : ?> id="logo"<?php endif; ?> class="logo logo-left <?php echo esc_attr( $exs_logo_image_class . ' ' . $exs_logo_background . ' ' . $exs_logo_padding_class . ' ' . $exs_logo_width_class ); ?>" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" itemprop="url">
	<?php
	//image
	if ( ! empty( $exs_custom_logo ) ) {
		...
		echo wp_get_attachment_image( $exs_custom_logo, 'full', false, array( 'alt' => $alt, 'loading' => 'eager' ) );
	}
