...
function cyber_security_services_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'cyber_security_services_theme_settings',
				'label'           => __( 'Hide Scroll Top', 'cyber-security-services' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'cyber-security-services' ),
					'off'    => __( 'Off', 'cyber-security-services' ),
				),
	...
	$wp_customize->add_control( new Cyber_Security_Services_Customizer_Customcontrol_Section_Heading( $wp_customize, 'cyber_security_services_section_shoppage_heading', array(
		'label'       => esc_html__( 'Shop Page Settings', 'cyber-security-services' ),
		'section'     => 'cyber_security_services_theme_settings',
	...
	$wp_customize->add_control(
		new Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'cyber_security_services_theme_settings',
				'label'           => __( 'Hide Shop Page Sidebar', 'cyber-security-services' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'cyber-security-services' ),
					'off'    => __( 'Off', 'cyber-security-services' ),
				),
	...
	$wp_customize->add_control(
		new Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'cyber_security_services_theme_settings',
				'label'           => __( 'Hide Single Product Page Sidebar', 'cyber-security-services' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'cyber-security-services' ),
					'off'    => __( 'Off', 'cyber-security-services' ),
				),
...
//theme width
    ...
    $wp_customize->add_setting( 'cyber_security_services_theme_button_color', array(
  	...
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'cyber_security_services_theme_button_color', array(
	    'description' => __('It will change the complete theme  Buttton color in one click.', 'cyber-security-services'),
	...
	$wp_customize->add_control( new Cyber_Security_Services_Customizer_Customcontrol_Section_Heading( $wp_customize, 'cyber_security_services_section_post_heading', array(
		'label'       => esc_html__( 'Post Structure', 'cyber-security-services' ),
	...
	$wp_customize->add_setting(
		'cyber_security_services_single_post_sidebar',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'cyber_security_services_layout',
				'label'           => __( 'Show Single Post Fullwidth', 'cyber-security-services' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'cyber-security-services' ),
					'off'    => __( 'Off', 'cyber-security-services' ),
				),
			...
			array(
				...
				'choices' => array(
					...
					'two_column' => array(
						...
						'name' => __( 'Two Column', 'cyber-security-services' )
					),
					'three_column' => array(
					...
					'grid_sidebar' => array(
						...
						'name' => __( 'Grid-Sidebar Layout', 'cyber-security-services' )
					),
					'grid_post' => array(
	...
	$wp_customize->add_control(new Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'cyber_security_services_layout',
				'label'           => __( 'Hide Date', 'cyber-security-services' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'cyber-security-services' ),
					'off'    => __( 'Off', 'cyber-security-services' ),
				),
	...
	$wp_customize->add_control(new Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'cyber_security_services_layout',
				'label'           => __( 'Hide Author/Admin', 'cyber-security-services' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'cyber-security-services' ),
					'off'    => __( 'Off', 'cyber-security-services' ),
				),
	...
	$wp_customize->add_control(new Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'cyber_security_services_layout',
				'label'           => __( 'Hide Comment', 'cyber-security-services' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'cyber-security-services' ),
					'off'    => __( 'Off', 'cyber-security-services' ),
				),
	...
	$wp_customize->add_control(new  Cyber_Security_Services_Fontawesome_Icon_Chooser(
		...
		'label'	=> __('Add Facebook Icon','cyber-security-services'),
		'transport' => 'refresh',
		'section'	=> 'cyber_security_services_urls',
	...
	$wp_customize->add_setting(
		'cyber_security_services_header_fb_target',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new  Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			'cyber_security_services_header_fb_target',
			array(
				'settings'        => 'cyber_security_services_header_fb_target',
				'section'         => 'cyber_security_services_urls',
	...
	$wp_customize->add_control(new  Cyber_Security_Services_Fontawesome_Icon_Chooser(
		...
		'label'	=> __('Add Twitter Icon','cyber-security-services'),
		'transport' => 'refresh',
		'section'	=> 'cyber_security_services_urls',
	...
	$wp_customize->add_setting('cyber_security_services_youtube_icon',array(
		'default'	=> 'fab fa-youtube',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new  Cyber_Security_Services_Fontawesome_Icon_Chooser(
        $wp_customize,'cyber_security_services_youtube_icon',array(
		'label'	=> __('Add Youtube Icon','cyber-security-services'),
		'transport' => 'refresh',
		'section'	=> 'cyber_security_services_urls',
		'setting'	=> 'cyber_security_services_youtube_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting(
		'cyber_security_services_header_ut_target',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new  Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			'cyber_security_services_header_ut_target',
			array(
				'settings'        => 'cyber_security_services_header_ut_target',
				'section'         => 'cyber_security_services_urls',
				'label'           => __( 'Open link in a new tab', 'cyber-security-services' ),
				'choices'		  => array(
					'1'      => __( 'On', 'cyber-security-services' ),
	...
	$wp_customize->add_setting('cyber_security_services_instagram_icon',array(
		'default'	=> 'fab fa-instagram',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new  Cyber_Security_Services_Fontawesome_Icon_Chooser(
        $wp_customize,'cyber_security_services_instagram_icon',array(
		'label'	=> __('Add Instagram Icon','cyber-security-services'),
		'transport' => 'refresh',
		'section'	=> 'cyber_security_services_urls',
		'setting'	=> 'cyber_security_services_instagram_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting(
		'cyber_security_services_header_ins_target',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new  Cyber_Security_Services_Customizer_Customcontrol_Switch(
			...
			'cyber_security_services_header_ins_target',
			array(
				'settings'        => 'cyber_security_services_header_ins_target',
				'section'         => 'cyber_security_services_urls',
				'label'           => __( 'Open link in a new tab', 'cyber-security-services' ),
				'choices'		  => array(
					'1'      => __( 'On', 'cyber-security-services' ),
