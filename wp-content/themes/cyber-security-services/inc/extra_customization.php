...
// sticky header
	...
	if( get_option( 'cyber_security_services_sticky_header',true) != 'on') {
	...
	if( get_option( 'cyber_security_services_sticky_header',true) != 'off') {

		$cyber_security_services_custom_style .='.menubarr.fixed{';

			$cyber_security_services_custom_style .='position: fixed;';
