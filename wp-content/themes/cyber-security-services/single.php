...
<?php
	$cyber_security_services_post_sidebar = get_option( 'cyber_security_services_single_post_sidebar' );
	if ( '1' == $cyber_security_services_post_sidebar ) {
		...
		<div class="content-area entry-content">
			<div id="main" class="site-main" role="main">
		       	<div class="row m-0">
					...
					<?php if ( '1' != $cyber_security_services_post_sidebar ) {?>
